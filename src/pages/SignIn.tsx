      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#FFFFFF] relative">
        ...
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <div className="relative">
            <div className="bg-white rounded-xl p-8 shadow-lg max-w-md">
              ...
              <div className="grid grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600 whitespace-nowrap">Language Support</div>
                </div>
                <div className="text-center">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg w-[260px] absolute -bottom-40 -right-8">
              <div className="flex items-center justify-between mb-4">  
                <div className="relative">  
                  <Ellipse className="width: 56px; height: 56.77px; top: 15.21px; left: 31.83px; gap: 0px; opacity: 0px;" />  
              ...
              <div>
                <div className="text-sm font-bold text-gray-600">Issues Fixed</div>
